...
Tel: (84) 8008925
          ...
          <ul class="social-icon">
            <li><a href="https://www.facebook.com/letien.thanh.081289"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
            <li><a href="https://www.instagram.com/shin_12o8/"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <p>(C) 2019, <span><a href="/" target="_blank">Shopmoto</a></span>, Designed by <span><a  target="_blank">shin_12o8</a></span></p>
        </div>
      </div>
    </div>
  </footer>
